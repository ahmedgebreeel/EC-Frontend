...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'shipinginfo',
        loadComponent: () =>
          import('./features/shiping-info/shiping-info').then((m) => m.ShipingInfo),
      },
      {
      ...
      },
      {
        path: 'returnpolicy',
        loadComponent: () =>
          import('./features/return-policy/return-policy').then((m) => m.ReturnPolicy),
      },
      {
        path: 'searchresults',
        loadComponent: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/shop/product-details/product-details').then((m) => m.ProductDetails),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'orders/edit/:id',
        loadComponent: () =>
          import('./admin/orders/edit-order/edit-order').then((m) => m.OrderEditComponent),
      },
    ],
  },
  {
